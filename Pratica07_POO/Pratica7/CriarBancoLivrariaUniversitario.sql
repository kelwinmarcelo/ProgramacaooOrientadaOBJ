...
alter table "livro"
add foreign key ("id_categoria") references "categoria_livro" ("id_categoria") on update restrict on delete restrict;
alter table "livro"
add foreign key ("id_editora") references "editora" ("id_editora") on update restrict on delete restrict;
alter table "autor_livro"
add foreign key ("id_isbn") references "livro" ("id_isbn") on update restrict on delete restrict;
alter table "autor_livro"
add foreign key ("id_autor") references "autor" ("id_autor") on update restrict on delete restrict;
alter table "pedido"
add foreign key ("id_funcionario") references "funcionario" ("id_funcionario") on update restrict on delete restrict;
alter table "pedido"
add foreign key ("id_cliente") references "cliente" ("id_cliente") on update restrict on delete restrict;
alter table "pedido_livro"
add foreign key ("id_isbn") references "livro" ("id_isbn") on update restrict on delete restrict;
alter table "pedido_livro"
add foreign key ("id_pedido") references "pedido" ("id_pedido") on update restrict on delete restrict;
alter table "encomenda"
add foreign key ("id_cliente") references "cliente" ("id_cliente") on update restrict on delete restrict;
alter table "encomenda"
add foreign key ("id_funcionario") references "funcionario" ("id_funcionario") on update restrict on delete restrict;
alter table "encomenda_livro"
add foreign key ("id_encomenda") references "encomenda" ("id_encomenda") on update restrict on delete restrict;
alter table "encomenda_livro"
add foreign key ("id_isbn") references "livro" ("id_isbn") on update restrict on delete restrict;
alter table "palavra_chave_livro"
add foreign key ("id_isbn") references "livro" ("id_isbn") on update restrict on delete restrict;
alter table "palavra_chave_livro"
add foreign key ("id_palavra_chave") references "palavra_chave" ("id_palavra_chave") on update restrict on delete restrict;
--
...
--
INSERT INTO categoria_livro (te_descricao)
VALUES ('Informática');
INSERT INTO categoria_livro (te_descricao)
VALUES ('Engenharia');
INSERT INTO categoria_livro (te_descricao)
...
INSERT INTO cliente (
                nm_cliente,
                nm_logradouro_cliente,
                nu_residencia_cliente,
                nm_bairro_cliente,
                nm_cidade_cliente,
                sg_uf_cliente,
                nu_cep_cliente,
...
INSERT INTO funcionario (
                ...
                nu_rg_funcionario,
                nu_cpf_funcionario,
                nm_logradouro_funcionario,
                nu_residencia_funcionario,
                nm_bairro_funcionario,
                nm_cidade_funcionario,
                nu_telefone_funcionario,
                dt_admissao,
                sg_sexo_funcionario
        )
VALUES (
...
VALUES (
                'Clipper 5.2   Iniciação e Referência',
                '0000000002',
                '1998-01-01',
                2,
                1,
...
VALUES (
                'SQL Server 7.0   Iniciação e Referência',
                '0000000014',
                '1998-01-01',
                1,
                0,
...
VALUES (
                'Introdução a Sistema de Bancos de Dados',
                '0000000015',
                '1995-01-01',
                4,
                0,
