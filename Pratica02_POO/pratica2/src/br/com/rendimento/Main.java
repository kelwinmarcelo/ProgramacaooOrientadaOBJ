...
public class Main {
    ...
    private static void mostrarRendimento() {
        System.out.printf(
                "O rendimento do investimento de R$ %.2f, com uma taxa de %1.0f%% a/m mês(es), durante %d será de R$ %.2f",
                rendimento1.getInvestimentoInicial(), rendimento1.gettaxaMes(), rendimento1.numeroMeses,
                rendimento1.calcularRemdimento());
